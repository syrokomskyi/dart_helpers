...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/dart_helpers.git`).
...
Go to the [pull request page of dart_helpers][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/dart_helpers/issues/new
[GitHub issues]: https://github.com/signmotion/dart_helpers/issues/new
[PRs]: https://github.com/signmotion/dart_helpers/pulls
