...
void main() {
  test('bestScale()', () {
    ...
    */
    ...
    for (final d in data) {
      final bestScale = PreferredAspect(d.screenSize).bestScale(
        d.originalSize,
        d.availableScales,
      );
  ...
  test('resolutionDivider()', () {
    ...
    for (final d in data) {
      final bestSize = PreferredAspect(d.screenSize).bestSize(d.pictureSizes);
  ...
  test('resolutionDividerForSize()', () {
    ...
    for (final d in data) {
      final resolutionDivider =
          PreferredAspect(d.size).resolutionDividerForSize(d.sizes);
  ...
  test('preferredAspectSize()', () {
    ...
    data.forEach((pictureSize, expectedAspectSize) {
      final size = PreferredAspect(pictureSize).preferredAspectSize();
    ...
    data.forEach((pictureSize, expectedAspectSize) {
      ...
      final size = PreferredAspect(ps).preferredAspectSize();
